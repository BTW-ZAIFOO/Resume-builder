    ...
    <>
      <footer className="dark:bg-gray-dark relative z-10 bg-white pt-16 md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap gap-x-12">
            <div className="mb-8 w-full px-4 md:w-1/2 lg:mb-0 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="text-body-color dark:text-body-color-dark mb-9 text-base leading-relaxed">
                  Your career journey starts with the perfect resume — let’s
                  build it together.
                </p>
            ...
            <div className="mb-8 w-full px-4 sm:w-1/2 md:w-1/4 lg:mb-0 lg:w-2/12 xl:w-2/12">
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              ...
              <a
                ...
                className="hover:text-primary"
              >
                . All Rights Reserved Under The Hawkrix.
              </a>
            </p>
          </div>
        </div>
